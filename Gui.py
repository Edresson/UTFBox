...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bt_logout.setGeometry(QtCore.QRect(100, 180, 80, 25))
        self.bt_logout.setObjectName("bt_logout")
        self.bt_changedir = QtWidgets.QPushButton(self.page)
        self.bt_changedir.setGeometry(QtCore.QRect(60, 40, 181, 25))
        self.bt_changedir.setObjectName("bt_changedir")
        self.bt_proxpage = QtWidgets.QPushButton(self.page)
        self.bt_proxpage.setGeometry(QtCore.QRect(80, 110, 131, 25))
        self.bt_proxpage.setObjectName("bt_proxpage")
        self.stackedWidget.addWidget(self.page)
        self.page_2 = QtWidgets.QWidget()
        self.page_2.setObjectName("page_2")
        self.bt_compartilhar = QtWidgets.QPushButton(self.page_2)
        self.bt_compartilhar.setGeometry(QtCore.QRect(80, 130, 91, 25))
        self.bt_compartilhar.setObjectName("bt_compartilhar")
        self.usuarioacomp = QtWidgets.QLineEdit(self.page_2)
        self.usuarioacomp.setGeometry(QtCore.QRect(50, 50, 161, 25))
        self.usuarioacomp.setObjectName("usuarioacomp")
        self.label_4 = QtWidgets.QLabel(self.page_2)
        self.label_4.setGeometry(QtCore.QRect(20, 30, 271, 20))
        self.label_4.setObjectName("label_4")
        self.bt_selefile = QtWidgets.QPushButton(self.page_2)
        self.bt_selefile.setGeometry(QtCore.QRect(70, 90, 121, 25))
        self.bt_selefile.setObjectName("bt_selefile")
        self.bt_voltar = QtWidgets.QPushButton(self.page_2)
        self.bt_voltar.setGeometry(QtCore.QRect(89, 180, 71, 25))
        self.bt_voltar.setObjectName("bt_voltar")
        self.stackedWidget.addWidget(self.page_2)
        self.label_warning = QtWidgets.QLabel(self.centralwidget)
        self.label_warning.setGeometry(QtCore.QRect(20, 220, 271, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bt_proxpage.setText(_translate("MainWindow", "Compartilhar arquivo"))
        self.bt_compartilhar.setText(_translate("MainWindow", "Compartilhar"))
        self.label_4.setText(_translate("MainWindow", "Usuario com que você quer compartilhar:"))
        self.bt_selefile.setText(_translate("MainWindow", "Selecione o Arquivo"))
